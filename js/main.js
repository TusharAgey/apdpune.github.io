...
function stickyMenu() {
	...
	if (scrollTop > offset) {
		...
		$('#mylogo-changing').html('<img height="80px" width="100px" src="img/logo1.png" alt="logo1"></a>');
	} else {
		$('#navbar').removeClass('navbar-small');
		$('#mylogo-changing').html('<img height="100px" width="300px" src="img/logo.png" alt="logo1"></a>');
	}
}
